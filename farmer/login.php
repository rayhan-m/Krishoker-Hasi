...
$con = mysqli_connect("localhost", "root", "", "hasi");
	...
	$result = mysqli_query($con, "SELECT * FROM farmer WHERE user_name = '" . $user_name. "' and password = '" . $password. "'");
    

	
	if ($row = mysqli_fetch_array($result)) {
		$_SESSION['user_name']=$user_name;
		$_SESSION['farmer_login']=TRUE;
                        ...
                        <div class="login-form">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="login-checkbox">
                                    ...
                                    <label>
                                        <a href="forget-password.php">Forgotten Password?</a>
                                    </label>
                                </div>
