                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" minlength="11" maxlength="11" name="phn_no" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" minlength="13" maxlength="13" name="nid" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div style="">
                            <button class="btn btn--radius-2 bg-gra-#57b846" style="background-color: #57b846;" name="btn" type="submit">Register</button>
