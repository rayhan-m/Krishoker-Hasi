<?php include("inc/header.php"); ?>
				...
				<div class="container">
					<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
						...
						<div class="col-md-12 ftco-animate text-center">
							...
							<p><a href="product.php" class="btn btn-primary">Buy Products</a></p>
						</div>
						...
						<div class="col-md-6 order-md-last align-items-stretch d-flex">
							<div class="category-wrap-2 ftco-animate img align-self-stretch d-flex" style="background-image: url(asset/images/category.jpg);">
								<div class="text text-center">
									...
									<p><a href="farmer/login.php" class="btn btn-primary">Sell Products</a></p>
								</div>
							</div>
						</div>
						<div class="col-md-6">
	...
	<section class="ftco-section img" style="background-image: url(asset/images/farmer1.jpg);">
		<div class="container">
			<div class="row justify-content-end">
				<div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate" style="color: #fff;">
					...
					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
					<h3><a href="#" style="color: #fff;">Bangladesh</a></h3>
					<span class="price" style="color: #fff;">TK 100 <a href="#" style="color: #fff;">now TK 80 only</a></span>
					<div id="timer" class="d-flex mt-5" style="color: #fff;">
						<div class="time" id="days"style="color: #fff;"></div>
						<div class="time pl-3" id="hours"style="color: #fff;"></div>
						<div class="time pl-3" id="minutes"style="color: #fff;"></div>
						<div class="time pl-3" id="seconds"style="color: #fff;"></div>
					</div>
				</div>
			</div>   		
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm ftco-animate">
					<a href="#" class="partner"><img src="asset/images/product-1.jpg" class="img-fluid" alt="Colorlib Template"></a>
				</div>
				<div class="col-sm ftco-animate">
					<a href="#" class="partner"><img src="asset/images/product-2.jpg" class="img-fluid" alt="Colorlib Template"></a>
				</div>
				<div class="col-sm ftco-animate">
					<a href="#" class="partner"><img src="asset/images/product-3.jpg" class="img-fluid" alt="Colorlib Template"></a>
				</div>
				<div class="col-sm ftco-animate">
					<a href="#" class="partner"><img src="asset/images/product-4.jpg" class="img-fluid" alt="Colorlib Template"></a>
				</div>
				<div class="col-sm ftco-animate">
					<a href="#" class="partner"><img src="asset/images/product-5.jpg" class="img-fluid" alt="Colorlib Template"></a>
				</div>
			</div>
		</div>
	</section>
